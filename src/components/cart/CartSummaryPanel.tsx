  ...
  return (
    <div className="bg-white border border-[#DDE1E6] rounded-[16px] overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-[#DDE1E6] bg-[#F7F8F9]">
        <h2 className="font-semibold text-[15px] text-[#0E1521]">{t("orderSummary")}</h2>
        ...
        {hasDiscount ? (
          <>
            <div className="flex items-center justify-between">
              <span className="text-[13px] text-[#5C6675]">{t("subtotal")}</span>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-[13px] font-semibold text-[#21A765]">{cartDiscount}</span>
            </div>
            <div className="h-px bg-[#DDE1E6]" />
            <div className="flex items-center justify-between">
              <span className="text-[14px] font-semibold text-[#0E1521]">{t("total")}</span>
              <span className="text-[20px] font-bold text-[#0E1521]">{cartTotal}</span>
            </div>
          </>
        ) : (
          <div className="flex items-center justify-between">
